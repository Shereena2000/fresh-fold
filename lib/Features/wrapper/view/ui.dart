...
import 'package:fresh_fold/Features/menu/view/ui.dart';
import 'package:fresh_fold/Features/order/view/ui.dart';
import 'package:fresh_fold/Features/payment/view/ui.dart';
...
class WrapperScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final List<NavItem> navItems = [
      ...
      NavItem(icon: Icons.payment, label: 'Payments'), 
